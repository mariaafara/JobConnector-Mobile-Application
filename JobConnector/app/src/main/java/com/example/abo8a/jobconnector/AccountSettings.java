...
public class AccountSettings extends AppCompatActivity {
    ...
    public void init() {
        ...
        setting.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                } else if (position == 2) {//update username
    ...
    private void updateUsername() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://sloppier-citizens.000webhostapp.com/job/changeUsername.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (json.getBoolean("success")) {
                        ...
                        user.user=usernameET.getText().toString();
    ...
    public void showChangUsernameDialog() {
        ...
        final Dialog Dialog = new Dialog(AccountSettings.this, R.style.Theme_Dialog);
    ...
    private void updatePassword() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://sloppier-citizens.000webhostapp.com/job/changePassword.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
        ...
        user.updateEmail(emailnew.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(!task.isSuccessful()){
                    ...
                    Toast.makeText(AccountSettings.this, "Email successfully modified", Toast.LENGTH_SHORT).show();
    ...
    private void updateEmail() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://sloppier-citizens.000webhostapp.com/job/changeEmail.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (json.getBoolean("success")) {
                        updateFirebaseEmail();
                        user.email=emailnew.getText().toString();
    ...
    private void deleteAccountfireBase() {
        Log.d("Account Setting", "deleteAccount");
        ...
        currentUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Log.w("Account Setting","Something is wrong!");
                }
            }
        });
    }
    private void deletAcountHost(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://sloppier-citizens.000webhostapp.com/job/closeAccount.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (json.getBoolean("success")) {
                        ...
                        startActivity(new Intent(AccountSettings.this, OnBoardingActivity.class));
