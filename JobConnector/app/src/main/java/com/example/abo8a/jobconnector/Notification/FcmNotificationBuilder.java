...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAAEmXzmvw:APA91bGx80-afW8u4ADwoVbKC99lM_iSkZkuVoSfITWOAGFdJp1AMdr87Gm-uVOBfXOoAmjLwGLgU_V5FoFHRw2fW5kt7mbQCkbIWtgetgk8zUIJ0QHs4nrE08ta9tlVAWfmt2z5RJc_";
    ...
    public void send() {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                System.out.println("++++ In Notification builder call failed + call is "+call.toString()+"  Exception is "+e.getMessage());
            }
