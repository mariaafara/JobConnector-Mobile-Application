...
public class CompanyRequests extends AppCompatActivity {
    private EmployeeAdapter myAppAdapter; //Array Adapter
    private RecyclerView recyclerView; //RecyclerView
    private RecyclerView.LayoutManager mLayoutManager;
    private final static String url = "https://sloppier-citizens.000webhostapp.com/company/companyRequests.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_requests);
    ...
    private void initialize() {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.companyRequestRecycleView); //Recylcerview Declaration
    ...
    private void init() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        while (iter.hasNext()) {
                            ...
                            try {
                                ...
                                if (!value.equals(true)) {
                                    ...
                                    JSONObject jsonStatus=(JSONObject)json.get(key2);
                                    ...
                                    try {
                                        ...
                                        job_post = new EmployeeData(jsonArray.getInt("Eid"), jsonArray.getString("fname"),
                                                ...
                                                ex,
                                                l,jsonArray1.getDouble("rating"),jsonStatus.getString("status"));
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("cid", CompanyMainActivity.cid + "");// etsearch.getText().toString()
                return params;
            }
    ...
    public void onBackPressed() {
        ...
        {
            Intent intent = new Intent(CompanyRequests.this, OnBoardingActivity.class);
