package com.example.abo8a.jobconnector.chat.util.data;
...
//            if(db.rawQuery("select * from "+FeedEntry.TABLE_NAME+" where "+FeedEntry.COLUMN_NAME_ID +"=\""+friend.id+"\"",null).getCount()>0) {
//                db.delete(FeedEntry.TABLE_NAME, FeedEntry.COLUMN_NAME_ID + "=\"" + friend.id+"\"", null);
